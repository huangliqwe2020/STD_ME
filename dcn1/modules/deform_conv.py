...
from ltr.models.STDeformable_ACMix.dcn1.functions.deform_conv_func import DeformConvFunction
...
class DeformConvPack(DeformConv):
    ...
    def __init__(self, in_channels, out_channels,
        ...
        out_channels = self.deformable_groups * self.kernel_size[0] * self.kernel_size[1] * self.kernel_size[2]
    ...
    def init_offset(self):
        # kernel = torch.zeros(27, 3, 3, 3)
        # count = 0
        # for j in range(3):
        #     for k in range(3):
        #         for h in range(3):
        #             kernel[count, j, k, h] = 1.
        #             count = count + 1
        # kernel = kernel.squeeze(0).repeat(self.out_channels, 1, 1, 1, 1)

        # self.conv_offset.weight = nn.Parameter(kernel)
